...
# BeamPro
beampro = path.join(basepath, 'resources/test_files/BeamPro/BeamPro.txt')

# Dektak
dektak = path.join(basepath, 'resources/test_files/Dektak/Dektak.csv')

# Diffrac
diffrac_brml = path.join(basepath, 'resources/test_files/Diffrac/Diffrac.brml')
diffrac_timelapse = path.join(basepath, 'resources/test_files/Diffrac/Diffrac_multiple.brml')
diffrac_brml_psd = path.join(basepath, 'resources/test_files/Diffrac/Diffrac_PSD.brml')

# EasyLog
easylog_file = path.join(basepath, 'resources/test_files/EasyLog/Easylog.txt')

# Edinst
f980_irf = path.join(basepath, 'resources/test_files/Edinst/F980_IRF.txt')
f980_irts_comma = path.join(basepath, 'resources/test_files/Edinst/F980_IRF_comma.txt')
f980_multi_irts = path.join(basepath, 'resources/test_files/Edinst/F980_IRF_multiple.txt')
f980_emscan = path.join(basepath, 'resources/test_files/Edinst/F980_EmScan.txt')
...
fluoressence_file = path.join(basepath, 'resources/test_files/FluorEssence/FluorEssence.txt')
fluoressence_multiple = path.join(basepath, 'resources/test_files/FluorEssence/FluorEssence_multiple.txt')

# FL Winlab
flwinlab_file = path.join(basepath, 'resources/test_files/FLWinlab/FLWinlab')

# LambdaSPX
lambdaspx_absorbance = path.join(basepath, 'resources/test_files/LambdaSPX/LambdaSPX_absorbance.dsp')
lambdaspx_transmittance = path.join(basepath, 'resources/test_files/LambdaSPX/LambdaSPX_transmittance.dsp')
lambdaspx_reflectance = path.join(basepath, 'resources/test_files/LambdaSPX/LambdaSPX_reflectance.dsp')
lambdaspx_absorbance2 = path.join(basepath, 'resources/test_files/LambdaSPX/LambdaSPX_absorbance_other-date-format.dsp')
...
# SBTPS
sbtps_seq1 = path.join(basepath, 'resources/test_files/SBTPS/SBTPS_SEQ1.SEQ')
sbtps_seq2 = path.join(basepath, 'resources/test_files/SBTPS/SBTPS_SEQ2.SEQ')
sbtps_seq3 = path.join(basepath, 'resources/test_files/SBTPS/SBTPS_SEQ3.SEQ')
sbtps_iv1 = path.join(basepath, 'resources/test_files/SBTPS/SBTPS_IV1.IV')
sbtps_iv2 = path.join(basepath, 'resources/test_files/SBTPS/SBTPS_IV2.IV')
sbtps_iv3 = path.join(basepath, 'resources/test_files/SBTPS/SBTPS_IV3.IV')

# Simple
simple_semicolon = path.join(basepath, 'resources/test_files/Simple/Simple_semicolon.csv')
simple_tab = path.join(basepath, 'resources/test_files/Simple/Simple_tab.txt')
...
spectrum_multiple = path.join(basepath, 'resources/test_files/Spectrum/spectrum_multiple.csv')
...
# Vesta
vesta_diffraction = path.join(basepath, 'resources/test_files/Vesta/Vesta.xy')
